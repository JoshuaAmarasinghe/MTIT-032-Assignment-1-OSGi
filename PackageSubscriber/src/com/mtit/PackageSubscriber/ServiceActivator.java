	...
	public void start(BundleContext context) throws Exception {
		...
		while(true) {
			...
			if ("Y".equalsIgnoreCase(result)) {
				...
				PackageCartPublisher packageCartPublisher = (PackageCartPublisher) context.getService(serviceReference2);
			...
			if(qt.equalsIgnoreCase("Y")) {
				System.out.println("Thank you for choosing Gym Fitness 032. Have a nice day !");
